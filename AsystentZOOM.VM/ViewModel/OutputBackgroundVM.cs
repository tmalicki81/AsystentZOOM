...
{
    [Serializable]
    public class OutputBackgroundVM : SingletonBaseVM, ILayerVM
    {
        ...
        public RelayCommand PlayCommand
            => _playCommand ??= new RelayCommand(() => EventAggregator.Publish($"{nameof(OutputBackgroundVM)}_Play"));

        private RelayCommand _stopCommand;
        public RelayCommand StopCommand
            => _stopCommand ??= new RelayCommand(() => EventAggregator.Publish($"{nameof(OutputBackgroundVM)}_Stop"));
    }
}