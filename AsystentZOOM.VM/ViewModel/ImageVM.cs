...
{
    public class ImageVM : SingletonBaseVM, ILayerVM
    {
        ...
        public RelayCommand PlayCommand
            ...
            {
                ChangeOutputSize();
                EventAggregator.Publish($"{nameof(ImageVM)}_Play");                
            }));

        private RelayCommand _stopCommand;
        public RelayCommand StopCommand
            => _stopCommand ?? (_stopCommand = new RelayCommand(() => EventAggregator.Publish($"{nameof(ImageVM)}_Stop")));
