...
namespace AsystentZOOM.VM.Common.AudioRecording
{
    ...
    public abstract class AudioRecordingProvider : BaseVM, IDisposable
    {
        ...
        /// Czy nagrywać dźwięk
        /// </summary>
        public static bool IsEnabledInThisMachine { get; set; }

        /// <summary>
        /// Czy nagrywać dźwięk z mikrofonu na bieżącej maszynie
        /// </summary>
        public static bool UseMicrophoneInThisMachine { get; set; }
        ...
        private RelayCommand _changeAudioRecordingEnabledCommand;
        public RelayCommand ChangeAudioRecordingEnabledCommand
            => _changeAudioRecordingEnabledCommand ??= new RelayCommand(ChangeAudioRecordingEnabled);

        private void ChangeAudioRecordingEnabled()
        {
            IsEnabledInThisMachine = !IsEnabledInThisMachine;
        }
